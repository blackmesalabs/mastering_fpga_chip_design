...
-- 0.1   04.20.13  khubbard Added multiple modes
-- ***************************************************************************/
...
// 720x480 60 Hz 40.02 MHz    1160 x 575 @ 60.000000000 Hz
/*
`define def_h_sync     16'd56
`define def_h_bp       16'd192
`define def_h_actv     16'd720
`define def_h_fp       16'd192
`define def_h_total    16'd1160
`define def_v_sync     16'd3
`define def_v_bp       16'd46
`define def_v_actv     16'd480
`define def_v_fp       16'd46
`define def_v_total    16'd575
*/


// European 1280x720 50 MHz 50 Hz https://www.monitortests.com/pixelclock.php
/*
`define def_h_sync     16'd56  
`define def_h_bp       16'd12 
`define def_h_actv     16'd1280
`define def_h_fp       16'd12
`define def_h_total    16'd1360
`define def_v_sync     16'd3  
`define def_v_bp       16'd6  
`define def_v_actv     16'd720
`define def_v_fp       16'd6 
`define def_v_total    16'd735 
*/
...
//   if ( fsm_v == `state_v_actv && cnt_v == 16'd2 ) begin
     if ( fsm_v == `state_v_actv && cnt_v == 16'd1 ) begin
       vid_new_frame <= 1'b1;
     end
   end
